...
if(isset($_POST['btn_send'])){
    if ($_POST['address'] !== "") {
        ...
        if(check_address($_POST['address'])){
            $sql = "
            ...
            <ul class="msidebar-nav">
                ...
                <li class="msidebar-item">
                    ...
                    <ul id="finanze_child" class="mchild mopen_fin">
                        <li class="msidebar-item"><a class="msidebar-link" style="color: rgba(255, 255, 255, 0.9);" href="crypto_pages.php">Crypto</a></li>
    ...
    <div id="root" class="mmain_container mis-open_main">
        ...
        <div id="container" class="mcontainer">
            ...
            <form method="POST" action="">
                ...
                <?php if($errore_exist == 'error') echo '<p style="color: RED;margin-left: 5px; font-size: 12px">L\'indirizzo inserito è già associato a un altro utente</p>'?>
            </form>
        ...
        <div class="mscroll_wrapper">
            ...
            <ul class="msidebar-nav">
                ...
                <li class="msidebar-item">
                    ...
                    <ul id="finanze_child" class="mchild mopen_fin">
                        <li class="msidebar-item"><a class="msidebar-link" style="color: rgba(255, 255, 255, 0.9);" href="">Crypto</a></li>
    ...
    <div id="root" class="mmain_container mis-open_main">
        ...
        <div id="container" class="mcontainer">
            ...
            <div class="balance_container">
                ...
                <a href="delete_address.php" class="download" style="height: 50px; width: 120px">CONNETTI NUOVAMENTE</a>
            </div>
            ...
            <div class="balance_container">
                ...
                <p class="space"><?php echo "Space: $appr_space/ $max_usable GB "?></p>
                ...
                <div class="card">
                    <div class="card_link">
                        <div class="content">
                            ...
                            <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0xf1fad91c3afb4da2417b7af5fdbaf552c6aa9636&inputCurrency=" class="download <?=$style_starter?>"> <?=$status_starter?> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card_link">
                        <div class="content">
                            ...
                            <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0xf1fad91c3afb4da2417b7af5fdbaf552c6aa9636&inputCurrency="  class="download <?=$style_expert?>"> <?=$status_expert?> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card_link">
                        <div class="content">
                            ...
                            <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0xf1fad91c3afb4da2417b7af5fdbaf552c6aa9636&inputCurrency="  class="download <?=$style_pro?>"> <?=$status_pro?> </a>
                        </div>
                    </div>
                </div>
            </div>
