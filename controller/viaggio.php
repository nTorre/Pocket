    ...
    <nav id="sidebar" class="msidebar mis-open_menu">
        ...
        <div class="mscroll_wrapper">
            ...
            <ul class="msidebar-nav">
                ...
                <li class="msidebar-item">
                    <a href="dashboard.php" data-toggle="collapse" class="msidebar-link">
    ...
    <div id="root" class="mmain_container mis-open_main">
        ...
        <div id="container" class="mcontainer">
            ...
            <div class="continer_viaggi">
                ...
                if($conta === 0)
                    echo '<p style="color: GREY; font-size: 20px" >Non sei ancora mai stato in ' . $all_countries[$N_ID] . ' </p>';?>

                <a href="viaggi.php" class="download" style="height: 50px; width: 100px">VEDI I TUOI VIAGGI</a>
            </div>
        </div>
