        ...
        <div class="mscroll_wrapper">
            ...
            <ul class="msidebar-nav">
                ...
                <li class="msidebar-item">
                    <a href="#dashboard" data-toggle="collapse" class="mnonactive">
            ...
            <ul class="msidebar-nav">
                ...
                <li class="msidebar-item">
                    ...
                    <ul id="files_child" class="mchild mopen_files" data-parent="#sidebar">
                        <li class="msidebar-item"><a class="msidebar-link" style="color: rgba(255, 255, 255, 0.9);" href="show_files.html">My Files</a></li>
